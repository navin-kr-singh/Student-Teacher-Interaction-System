...
<body>
    ...
    <%
        ...
        String picturepath = "images/" + teacherid + ".jpg";
    %>
    <img src="<%= picturepath %>" id="pic"/>
    <span id="name">${teachername}</span><br />
    <span id="dept">Department: ${department}</span>
    <span id="desg">Designation: ${designation}</span>
    <a href="${hrefvalue}"><input type="button" value="Contact" /></a>
</body>
</html>